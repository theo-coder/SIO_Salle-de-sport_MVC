...
class viewHomeMenu implements viewsComponent_interface {
	...
	public function insideHtml()
	{
		$str='
					...
					<ul class="navbar-nav mr-auto">
						...
						if(!Session::isLogged()){
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<a class="dropdown-item active" href="index.php?case=FO_Newsletter&action=subscribe">Inscription</a>
								<a class="dropdown-item active" href="index.php?case=FO_Newsletter&action=unsubscribe">Désinscription</a>
							</div>
						</li>';
						}
			...
			';
			if(Session::isLogged()){
				$str.='<div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
								...
								<div class="mymodal-container">
									<div class="mymodal-body">
										...
										<center class="mymodal-footer-content">';
											if($this->type!=0){
												$str.='<a id="admin-button" href="../BO/index.php">Pannel Administrateur</a>';
											}
											$str.='<a id="deco-button" href="index.php?case=FO_Disconnect">Déconnexion</a>
											<a id="details" href="index.php?case=FO_Account&action=view">Plus de détails</a>
										</center>
									</div>
								</div>
				...
				$str.='<div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" href="index.php?case=FO_Registration&action=register" id="userAdd">Inscription</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="index.php?case=FO_Registration&action=connexion" id="userConnect">Connexion</a>
						</li>
					</ul>
				</div>';
			}
