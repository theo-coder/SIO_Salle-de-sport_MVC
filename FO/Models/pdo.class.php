...
class PDO_SDS {
    ...
    function addGymComment($id, $text){
        $req =  self::$pdo->prepare('INSERT INTO `COMMENTAIRE_SALLE` (`idUtilisateur`,`texteCommentaireSalle`,`dateCommentaireSalle`) VALUES (:id, :text, Date(Now()));');
        $req->bindParam('id',$id);
